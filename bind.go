...
type (
	...
	bindMultipleUnmarshaler interface {
		UnmarshalParams(params []string) error
	}

	// FallbackBinder is the same as echo.DefaultBinder but with fallback behavior added.
	FallbackBinder struct{}
)

var DefaultBinder = &FallbackBinder{}
...
func (b *FallbackBinder) BindBody(c echo.Context, i any) (err error) {
	req := c.Request()
...
func (b *FallbackBinder) Bind(i any, c echo.Context) (err error) {
...
func (b *FallbackBinder) BindData(destination any, data map[string][]string, tag string) error {
